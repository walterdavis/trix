...
By default, Trix supports the inline attributes `bold`, `italic`, `href`, and `strike`, and the block-level attributes `heading1`, `heading2`, `heading3`, `quote`, `code`, `bullet`, and `number`.
